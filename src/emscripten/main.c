...
void set_joyp_up(Emulator* e, Bool set) { e->state.JOYP.buttons.up = set; }

void set_joyp_down(Emulator* e, Bool set) { e->state.JOYP.buttons.down = set; }

void set_joyp_left(Emulator* e, Bool set) { e->state.JOYP.buttons.left = set; }

void set_joyp_right(Emulator* e, Bool set) {
  e->state.JOYP.buttons.right = set;
}

void set_joyp_b(Emulator* e, Bool set) { e->state.JOYP.buttons.B = set; }

void set_joyp_a(Emulator* e, Bool set) { e->state.JOYP.buttons.A = set; }

void set_joyp_start(Emulator* e, Bool set) {
  e->state.JOYP.buttons.start = set;
}

void set_joyp_select(Emulator* e, Bool set) {
  e->state.JOYP.buttons.select = set;
}
